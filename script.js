const translations = {
  it: {
    ...
    'gallery-title': 'Foto',
    'card1-title': 'Optometrista',
    'card1-desc': 'Esperienza in esami della vista, fitting di lenti a contatto, consulenza e correzione visiva. Formazione pratica in corso.',
    ...
    'footer': 'Laura Hoyos — Ottica e Optometria · Milano / Madrid',
    lang: 'IT',
    flag: '🇮🇹'
  },
  en: {
    ...
    'card1-title': 'Optometrist',
    'card1-desc': 'Experience in eye exams, contact lens fitting, consultation, and vision correction. Hands-on training in progress.',
  ...
  es: {
    ...
    'gallery-title': 'Fotos',
    'card1-title': 'Optometrista',
    'card1-desc': 'Experiencia en exámenes de vista, adaptación de lentes de contacto, consulta y corrección visual. Formación práctica en curso.',
    'card2-title': 'Prácticas actuales',
    'card2-desc': 'MultiOpticas + Hospital Infanta Leonor, Madrid. Formación clínica en entorno hospitalario.',
    'card3-title': 'Estudios',
    'card3-desc': 'Universidad de Bicocca (Milán) y Complutense (Madrid). El objetivo es el máster en optometría clínica en Madrid.',
    'project-eyebrow': 'Mi proyecto',
    'project-title': 'La clínica de mis sueños',
    'project-p1': 'Imagina un lugar donde la optometría se encuentra con la tecnología, donde cada paciente es atendido con atención y profesionalidad. Donde no somos solo una tienda de gafas, sino un centro completo de salud visual.',
    'project-p2': 'Este es mi objetivo. No solo vender lentes — hacer la diferencia en la vida de las personas a través del cuidado de la vista.',
    'feat1': '✅ Exámenes de vista completos y modernos',
    'feat2': '✅ Lentes de contacto de última generación',
    'feat3': '✅ Tecnología avanzada para diagnóstico',
    'feat4': '✅ Un equipo apasionado y preparado',
    'feat5': '✅ Un entorno acogedor y profesional',
    'cta-title': 'Busco colaboradores y oportunidades',
    'cta-desc': 'Si buscas una optometrista motivada, o quieres formar parte de este proyecto, hablemos.',
    'cta-box-btn': 'Ponte en contacto',
    'contact-title': 'Hablemos',
    'contact-intro': 'Si buscas una optometrista, quieres colaborar o simplemente quieres saludar — estoy aquí.',
    'footer': 'Laura Hoyos — Óptica y Optometría · Milán / Madrid',
    lang: 'ES',
    flag: '🇪🇸'
  }
};

const langCycle = ['it', 'en', 'es'];
...
// Language
langSwitch.addEventListener('click', cycleLang);

// Init
if (localStorage.getItem('laura-theme')) {
  setTheme(localStorage.getItem('laura-theme'));
} else {
  applySystemTheme();
}

if (localStorage.getItem('laura-lang')) {
  setLang(localStorage.getItem('laura-lang'));
} else {
  setLang('it');
}